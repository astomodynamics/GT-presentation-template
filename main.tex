...
\author[Tomohiro Sasaki]{\href{mailto:tomohiro.sasaki@gatech.edu}{Tomohiro Sasaki}\\Ph.D. Student at Georgia Institute of Technology}
\date{\today}


\newcommand{\insertfootlinetitle}{\the\year}
...
\begin{verbatim}
\includegraphics[width=\textwidth]{images/gt_tower.jpg}
\end{verbatim}
\end{block}
...
\begin{frame}{Embed GIF}
    ...
    \centering
    \animategraphics[autoplay, loop,width=4cm]{10}{videos/gifs/blinking-eyes-huh-}{0}{33}
\end{frame}
...
\begin{frame}{Embed Video}
    ...
    height=0.4\textwidth,
    activate=pageopen,
    addresource=videos/pendulum.mp4,
    flashvars={
      source=videos/pendulum.mp4
      &autoPlay=true
      &scaleMode=letterbox
  ...
  ]{\includegraphics[height=0.4\textwidth]{plots/pendulum.png}}{VPlayer.swf}
\end{frame}
...
\begin{frame}{Adding Bibliography}
    ...
    \begin{itemize}
        \item Footnote citation command is \texttt{$\backslash$footnote\{$\backslash$cite\{YOUR-REFERENCE-KEY\}\}}\footnote[1]{\cite{Sasaki.Lightsey.2022}}
...
\begin{frame}{Changing Footers}
    ...
    \texttt{$\backslash$newcommand\{$\backslash$insertfootlinetitle\}\{<YOUR-FOOTLINE-TITLE>\}}
\end{frame}

\begin{frame}{Changing Back Matter}
    The back matter can be modified in \texttt{beamerthemegt.sty}.
